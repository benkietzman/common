...
include_once(dirname(__FILE__).'/../radial/Radial.php');
// }}}
//! RadialQuery Class
/*!
* Provides functions for performing database queries through Radial.
*/
class RadialQuery extends DatabaseQuery
{
  // {{{ variables
  private $m_radial;
  private $m_strQuery;
  ...
  public function __construct($bError = false)
  {
    ...
    $this->m_radial = new common\Radial;
    $this->m_query = false;
    $this->m_unRow = 0;
    $this->m_unRows = 0;
  }
