...
Vue.component('commonMenu',
{
  ...
  `
    <div style="margin-bottom: 50px;">
      <div v-if="common.menu" class="navbar navbar-expand-lg navbar-dark bg-secondary" role="navigation">
      ...
      <div v-if="common.submenu" class="navbar navbar-expand-lg navbar-dark bg-dark" role="navigation">
        <div class="container-fluid">
